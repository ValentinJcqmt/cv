// ---- Navigation ----
		...
		nav.right = function(){
			if( nav.horizontal != "right" ){
				...
				console.log(nav.vertical + ", " + nav.horizontal);
		...
		nav.left = function(){
			if ( nav.horizontal != "left" ){
				...
				nav.mainDiv.style.marginLeft = "8%";
				nav.horizontal = "left";
				console.log(nav.vertical + ", " + nav.horizontal);
		...
		nav.arrowEnable = function(){
			if( nav.horizontal == "left"){
				nav.leftArrow.style.opacity = 0.2;
			...
			if( nav.horizontal == "right"){
				nav.rightArrow.style.opacity = 0.2;
			...
			if( nav.vertical == "top"){
				nav.topArrow.style.opacity = 0.2;
			...
			if( nav.vertical == "bottom"){
				nav.bottomArrow.style.opacity = 0.2;
